...
const MainFooter = ({ intl }) => (
  <div className="container border-top">
    <footer className="py-5">
      <div className="row">
        <div className="col-3">
          <h5>{intl.formatMessage({ id: 'common.ariaLabel.menu' })}</h5>
        ...
        <div className="col-3">
          <h5>{intl.formatMessage({ id: 'common.ariaLabel.externalLink' })}</h5>
          <ul className="nav flex-column">
            <li className="nav-item mb-2">
              <ExternalLink
                linkTo={intl.formatMessage({ id: 'common.externalLinks.devweb.linkTo' })}
                ariaLabel={intl.formatMessage({ id: 'common.externalLinks.devweb.ariaLabel' })}
                className="nav-link p-0 text-muted"
              >
                {intl.formatMessage({ id: 'common.externalLinks.devweb.label' })}
              </ExternalLink>
            </li>
          </ul>
        </div>
        ...
        <div className="col-4 offset-1">
          <form>
            <h5>{intl.formatMessage({ id: 'common.newsletter.subscribeText' })}</h5>
            ...
            <div className="d-flex w-100 gap-2">
              ...
              <input
                ...
                placeholder={intl.formatMessage({ id: 'common.ariaLabel.emailText' })}
              />
              <button className="btn btn-primary" type="button">
                {intl.formatMessage({ id: 'common.newsletter.subscribe' })}
              </button>
            </div>
          </form>
        </div>
      ...
      <div className="d-flex justify-content-between py-4 my-4 border-top">
        <p>{intl.formatMessage({ id: 'footer.companyRights' })}</p>
